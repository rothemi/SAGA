...
for (i in 3) { Results[i,11] <- length(eval(parse(text=paste("GA.",i, sep="")))$optVariables)  }
Results[11,11] <- length(GA.FINAL$optVariables)

### 12. Resampling accuracy for the GA model
for (i in 3) { Results[i,12] <- eval(parse(text=paste("accuracy.external.",i, sep=""))) }
...
for (i in 3) {Results[i,13] <- ci(eval(parse(text=paste("accuracy.external.opt.",i, sep=""))))[2]}
...
for (i in 3) {Results[i,14] <- ci(eval(parse(text=paste("accuracy.external.opt.",i, sep=""))))[3]}
...
for (i in 3) { Results[i,21] <- confusionMatrix(as.factor(eval(parse(text=paste("Prediction_GA.",i, sep="")))[,7]), as.factor(eval(parse(text=paste("Prediction_GA.",i, sep="")))$TrueLabel))$overall[1] }

### 22. lower bound of confidence intervall TestSet accuracy for the SVM-GA model
for (i in 3) { Results[i,22] <- confusionMatrix(as.factor(eval(parse(text=paste("Prediction_GA.",i, sep="")))[,7]), as.factor(eval(parse(text=paste("Prediction_GA.",i, sep="")))$TrueLabel))$overall[3] }

### 23. upper bound of confidence intervall TestSet accuracy for the SVM-GA model
for (i in 3) { Results[i,23] <- confusionMatrix(as.factor(eval(parse(text=paste("Prediction_GA.",i, sep="")))[,7]), as.factor(eval(parse(text=paste("Prediction_GA.",i, sep="")))$TrueLabel))$overall[4] }
...
### for SVM-GA
df.results.GA              <- df.results[3,]    # subset for the Training / TestSet splits in which GA was performed 
