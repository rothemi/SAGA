...
#############################################################################################################################################
#############################################################################################################################################
#### Split 07 / TestSet 07 - Figure 3 e,f,g  #################################################################################################
#############################################################################################################################################
#############################################################################################################################################
set.seed(543)
...
### Figure 3e,f ##############################################################################################
trellis.par.set(caretTheme())
plot(rfe.7, type = c("g", "o"))  # Figure 3e
plot(rfe.7, type = c("g", "o"), xlim = c(0,61))    # Figure 3f max at 26 optVars found by rfe
...
### Figure 3g plot external accuracy over the iterations ################################################################
...
#############################################################################################################################################
#############################################################################################################################################
#### Analyze all results from the 10 Test/Training splits ###################################################################################
#############################################################################################################################################
#############################################################################################################################################
...
#############################################################################################################################################
### 2. Supplementary Data 4 tab 1: summary of features, resampling- and test set accuracies #################################################
#############################################################################################################################################
library(gmodels)

### 2.1. create data.frame for all 10 TestSet/TrainingSet Splits
Results <- data.frame(Testset = seq(1,10,by=1), FeatureNumber_full = rep(NA,10), ResamplingAccuracy_full=rep(NA,10),CI_full_lower=rep(NA,10),CI_full_upper=rep(NA,10), 
                      FeatureNumber_rfe = rep(NA,10), ResamplingAccuracy_rfe = rep(NA,10), CI_rfe_lower=rep(NA,10),CI_rfe_upper=rep(NA,10), P_full_vs_rfe=rep(NA,10),
                      FeatureNumber_GA  = rep(NA,10), ResamplingAccuracy_GA = rep(NA,10),CI_GA_lower=rep(NA,10),CI_GA_upper=rep(NA,10),
                      Accuracy_TestSet_full = rep(NA,10), CI_Test_full_lower=rep(NA,10),CI_Test_full_upper=rep(NA,10),
                      Accuracy_TestSet_rfe = rep(NA,10),  CI_Test_rfe_lower=rep(NA,10),CI_Test_rfe_upper=rep(NA,10),
                      Accuracy_TestSet_GA = rep(NA,10),   CI_Test_GA_lower=rep(NA,10),CI_Test_GA_upper=rep(NA,10),
                      Accuracy_TestSet_SAGA = rep(NA,10),AUROC_SAGA = rep(NA,10), AUPRC_SAGA = rep(NA,10),AUPRC_random = rep(NA,10))
...
#############################################################################################################################################
### 3. Plot resampling results vs TestSet results: Figure 3 h-j #############################################################################
#############################################################################################################################################

df.results <- Results[c(1:10),]   # export data for the 10 Training / Test Sets w/o FinalSet

### for full model / Figure 3h: #############################################################################
...
#############################################################################################################################################
### 5. Confusion matrices of aggregated TestSets / Supplementary Data 4 tab 2 ###############################################################
#############################################################################################################################################
...
#############################################################################################################################################
### 2.7. Toplist of predictors chosen during the 10 iterations Table 1 / Supplementary Data 4 Tab 3 #########################################
#############################################################################################################################################
